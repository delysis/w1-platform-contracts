...
pub use model::{
    ...
    ObservationEnvelopeV0, OwnershipFactsV0, PrerequisiteArtifactBytesV0, PrerequisiteKindV0,
    PrerequisiteV0, ReplayProgramV0, ReplayRecipeV0, StateDispositionV0, StateIdentityV0,
...
pub use validation::{
    ValidationError, compare_candidate, sha256_identity, validate_baseline, validate_lock,
